...
import java.awt.*;
 ...
 import java.util.ArrayList;  // storing all aliens and bullets
 import java.util.Random; //generate random color for sliens
 import javax.swing.*;
 ...
 public class SpaceInvaders extends JPanel implements ActionListener, KeyListener {
     ...
     int bulletVelocityY = -10; //bullet moving speed,negative as the bullet is moving in upward y axis direction
     ...
     public void move() {
         ...
         for (int i = 0; i < alienArray.size(); i++) {
             ...
             if (alien.alive) {
                 ...
                 //if alien touches the borders and change the direction of their movement
